...
const followersArray = ["Ashurik522", "jzkime", "tetondan", "dustinmyers", "justsml", "luishrd", "bigknell", "FytaiLynch", "christinebussingerdev"];
...
// axios.get("https://api.github.com/users/tim-sansone")
//   .then((res) => {
//     const container = document.querySelector(".cards")
//     container.appendChild(newCard(res));
//   })
//   .catch((err) => {
//     console.log(err);
//   })
...
function newCard(obj) {
  ...
  // set all classes, attributes, and content
